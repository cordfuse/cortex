...
5. **It has a personality.** Cortex actually has three AI layers working together. The **active actor** is who you talk to — that's the one with the personality. Cortex ships with 73 built-in personalities for the active actor: Casey (warm, friendly, plain English), Atlas (precise and methodical), a wellness coach, a fitness trainer named Arnold, a registered dietitian named Dr. Mira, a psychologist-style listener, a psychiatrist-style listener, a family doctor, spiritual guides for nine faith traditions (Judaism, Christianity, Islam, Hinduism, Buddhism, Sikhism, Taoism, Eastern Orthodoxy, and Indigenous Elders), pop culture figures (Yoda, Spock, Indiana Jones, Captain Picard, Buffy, Bill Murray, Tony Soprano, Mr. Miyagi, and more), and IT domain experts (developers, DevOps, cloud architects, product managers, QA, designers, functional consultants). Pick the voice that works for you. Or describe one in plain English — and the active actor will be created on the spot. The second layer — the **Bootstrap actor** — handles the operational stuff (sync, version checks, session management) in a clean clinical voice and steps out for normal conversation. The third layer — the **hidden scribe** — is silent. It just files things. You won't ever see it in chat. It works the same in every session no matter which active actor you pick.
