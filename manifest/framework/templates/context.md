...
*The hidden scribe (the protocol role that handles all filing) is implicit and has no configuration — see manifest/framework/protocol/CORTEX.md → Hidden Scribe.*
