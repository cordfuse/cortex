...
Source ideas: records/2026-05-02-0131-idea-actor-selection-at-hello.md and records/2026-05-02-0159-idea-actor-drift-detection.md (filed in personal cortex during overnight Bootstrap-voiced session).
...
2026-05-01 15:30 UTC | protocol/CORTEX.md | canonical category map updated to reflect alpha.20 reality. "Defaults" row replaced with "Bootstrap" row. Casey + Atlas moved to Distinctive Voices. Pop Culture row extended with alpha.10 additions. New Information Technology row (alpha.12). Dr. Mira added to Clinical & wellness. Closes the staleness flagged by mobile-Sonnet during 2026-05-01 Phase 6 validation (`records/2026-05-01-1029-bug-canonical-category-map-stale.md`).
