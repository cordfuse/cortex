...
2026-05-03 18:35 UTC | CLAUDE.md | new section "Verb precedence (v4.0.0-alpha.28+)" — cortex protocol's session verbs (hello, goodbye, sync, status, search, list verbs, list personalities, list actors) take precedence over any parent CLAUDE.md's verb definitions inside cortex repos. Closes alpha.27 Phase B FAIL: librarian Hello format pre-empting cortex Bootstrap greeting.
